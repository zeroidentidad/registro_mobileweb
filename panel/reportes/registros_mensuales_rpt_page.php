...
//
$registros_array = $registros->select_asistencias($conn, $anio, $mes, "", "", "");

$total_registros = $registros->numeroRegistrosReporte($conn, $anio, $mes, "", "", "");
				...
				<table class="page_header">
					<tr>
						<td style="width: 100%; text-align: center;">
							<h1>REGISTROS&nbsp;<u><?php print $anio; ?></u>&nbsp;-&nbsp;<u><?php print strtoupper($nmes); ?></u></h1>
						</td>
					</tr>
				</table>
			</page_header>
