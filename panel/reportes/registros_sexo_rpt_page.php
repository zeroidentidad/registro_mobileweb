...
//
$registros_array = $registros->select_asistencias($conn, $anio, $mes, $evento, $sexo, "");

$total_registros = $registros->numeroRegistrosReporte($conn, $anio, $mes, $evento, $sexo, "");
			...
			<page_header>
				<table class="page_header">
					<tr>
						...
						<?php } else if($tr=='2'){ ?>
							<h1><u><?php print strtoupper($nsexo); ?></u>&nbsp;-&nbsp;REGISTROS&nbsp;<u><?php print $anio; ?></u>&nbsp;-&nbsp;<u><?php print strtoupper($nmes); ?></u></h1>
						<?php } else if($tr=='3'){ ?>
							<h1><u><?php print strtoupper($nsexo); ?></u>&nbsp;-&nbsp;REGISTROS&nbsp;<u><?php print $anio; ?></u>&nbsp;-&nbsp;<u><?php print strtoupper($nmes); ?></u>&nbsp;-&nbsp;<u><?php print 'N° '.$evento; ?></u></h1>
						<?php } ?>	
						</td>
					</tr>
				</table>
