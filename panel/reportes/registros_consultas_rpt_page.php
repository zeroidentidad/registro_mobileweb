...
//
$registros_array = $consultas->select_asistencias($conn, $anio, $folio, $nombre, $apellidos, $sexo, $profesion, $matricula, $email, $celular, $nota);
...
<style>
	*{margin:0; padding: 0;}
	...
	<?php
			...
			print '<td class="td2" style="width:5%;">'.wordwrap($registros_array[$i]["id_evento"], 7, '<br/>', true).'</td>';
			...
			print '<td class="td2" style="width:15%;">'.html_entity_decode($registros_array[$i]["nota"]).'</td>';
			print '</tr>';
			}
			print '</table>';
